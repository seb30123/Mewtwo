...
/home/sebbrg/Mewtwo/attacks/03-clangover/extension/binaries_hqc/hqc_clang-15_Os_reed_solomon.o:     file format elf64-littleaarch64
...
00000000000000dc <PQCLEAN_HQC128_CLEAN_reed_solomon_decode>:
 ...
 3bc:	2a3403e9 	mvn	w9, w20
 3c0:	5280002c 	mov	w12, #0x1                   	// #1
 3c4:	b270bd29 	orr	x9, x9, #0xffffffffffff0000
 3c8:	cb14c3e8 	neg	x8, x20, lsl #48
 3cc:	910303ea 	add	x10, sp, #0xc0
 3d0:	d2e0002b 	mov	x11, #0x1000000000000       	// #281474976710656
 3d4:	790183ec 	strh	w12, [sp, #192]
 3d8:	f9002fe9 	str	x9, [sp, #88]
 3dc:	52800049 	mov	w9, #0x2                   	// #2
 3e0:	78696aac 	ldrh	w12, [x21, x9]
 3e4:	937ffd0d 	asr	x13, x8, #63
 3e8:	8b0b0108 	add	x8, x8, x11
 3ec:	0a0d018c 	and	w12, w12, w13
 3f0:	7829694c 	strh	w12, [x10, x9]
 3f4:	91000929 	add	x9, x9, #0x2
 3f8:	f100813f 	cmp	x9, #0x20
 3fc:	54ffff21 	b.ne	3e0 <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x304>  // b.any
 400:	794187e8 	ldrh	w8, [sp, #194]
 404:	aa1f03f5 	mov	x21, xzr
 408:	b94007e9 	ldr	w9, [sp, #4]
 40c:	52800056 	mov	w22, #0x2                   	// #2
 410:	910903f7 	add	x23, sp, #0x240
 414:	910303f8 	add	x24, sp, #0xc0
 418:	910883f9 	add	x25, sp, #0x220
 41c:	4a090108 	eor	w8, w8, w9
 420:	790187e8 	strh	w8, [sp, #194]
 424:	8b1606e8 	add	x8, x23, x22, lsl #1
 428:	f9402fea 	ldr	x10, [sp, #88]
 42c:	78767b09 	ldrh	w9, [x24, x22, lsl #1]
 430:	5280005b 	mov	w27, #0x2                   	// #2
 434:	aa1503fc 	mov	x28, x21
 438:	785fe108 	ldurh	w8, [x8, #-2]
 43c:	0b0a02ca 	add	w10, w22, w10
 440:	934f3d4b 	sbfx	x11, x10, #15, #1
 444:	d3503d54 	lsl	x20, x10, #48
 448:	0a0b0108 	and	w8, w8, w11
 44c:	4a09011a 	eor	w26, w8, w9
 450:	78367b1a 	strh	w26, [x24, x22, lsl #1]
 454:	787c6ae1 	ldrh	w1, [x23, x28]
 458:	937ffe93 	asr	x19, x20, #63
 45c:	787b6b20 	ldrh	w0, [x25, x27]
 460:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_gf_mul>
 464:	0a130008 	and	w8, w0, w19
 468:	d1000b9c 	sub	x28, x28, #0x2
 46c:	4a1a011a 	eor	w26, w8, w26
 470:	91000b7b 	add	x27, x27, #0x2
 474:	b1000b9f 	cmn	x28, #0x2
 478:	78367b1a 	strh	w26, [x24, x22, lsl #1]
 47c:	54fffec1 	b.ne	454 <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x378>  // b.any
 480:	910006d6 	add	x22, x22, #0x1
 484:	91000ab5 	add	x21, x21, #0x2
 488:	f10042df 	cmp	x22, #0x10
 48c:	54fffcc1 	b.ne	424 <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x348>  // b.any
 490:	910883eb 	add	x11, sp, #0x220
 494:	aa1f03e9 	mov	x9, xzr
 498:	2a1f03e8 	mov	w8, wzr
 49c:	910483ea 	add	x10, sp, #0x120
 4a0:	9000000c 	adrp	x12, 0 <PQCLEAN_HQC128_CLEAN_reed_solomon_encode>
 4a4:	9100018c 	add	x12, x12, #0x0
 4a8:	f809617f 	stur	xzr, [x11, #150]
 4ac:	f807617f 	stur	xzr, [x11, #118]
 4b0:	910a83eb 	add	x11, sp, #0x2a0
 4b4:	f90157ff 	str	xzr, [sp, #680]
 4b8:	f90153ff 	str	xzr, [sp, #672]
 4bc:	f9015bff 	str	xzr, [sp, #688]
 4c0:	f90147ff 	str	xzr, [sp, #648]
 4c4:	f90143ff 	str	xzr, [sp, #640]
 4c8:	f9014bff 	str	xzr, [sp, #656]
 4cc:	3869694f 	ldrb	w15, [x10, x9]
 4d0:	92403d11 	and	x17, x8, #0xffff
 4d4:	78697990 	ldrh	w16, [x12, x9, lsl #1]
 4d8:	aa1f03ee 	mov	x14, xzr
 4dc:	2a1f03ed 	mov	w13, wzr
 4e0:	d37ffa31 	lsl	x17, x17, #1
 4e4:	710001ff 	cmp	w15, #0x0
 4e8:	786e6972 	ldrh	w18, [x11, x14]
 4ec:	1a9f07e0 	cset	w0, ne	// ne = any
 4f0:	eb0e023f 	cmp	x17, x14
 4f4:	1a9f17e1 	cset	w1, eq	// eq = none
 4f8:	6a010000 	ands	w0, w0, w1
 4fc:	1a9f1201 	csel	w1, w16, wzr, ne	// ne = any
 500:	0b0001ad 	add	w13, w13, w0
 504:	0b120032 	add	w18, w1, w18
 508:	782e6972 	strh	w18, [x11, x14]
 50c:	910009ce 	add	x14, x14, #0x2
 510:	f10079df 	cmp	x14, #0x1e
 514:	54fffe81 	b.ne	4e4 <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x408>  // b.any
 518:	0b0801a8 	add	w8, w13, w8
 51c:	91000529 	add	x9, x9, #0x1
 520:	f100b93f 	cmp	x9, #0x2e
 524:	54fffd41 	b.ne	4cc <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x3f0>  // b.any
 528:	12003d08 	and	w8, w8, #0xffff
 52c:	b201e3f9 	mov	x25, #0x8888888888888888    	// #-8608480567731124088
 530:	aa1f03f3 	mov	x19, xzr
 534:	5280003b 	mov	w27, #0x1                   	// #1
 538:	910303fc 	add	x28, sp, #0xc0
 53c:	f2911139 	movk	x25, #0x8889
 540:	b9004fe8 	str	w8, [sp, #76]
 544:	910a83e8 	add	x8, sp, #0x2a0
 548:	b27f011a 	orr	x26, x8, #0x2
 54c:	928003b8 	mov	x24, #0xffffffffffffffe2    	// #-30
 550:	910a83e8 	add	x8, sp, #0x2a0
 554:	78737900 	ldrh	w0, [x8, x19, lsl #1]
 558:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_gf_inverse>
 55c:	2a0003f6 	mov	w22, w0
 560:	52800037 	mov	w23, #0x1                   	// #1
 564:	52800054 	mov	w20, #0x2                   	// #2
 568:	52800035 	mov	w21, #0x1                   	// #1
 56c:	2a1703e0 	mov	w0, w23
 570:	2a1603e1 	mov	w1, w22
 574:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_gf_mul>
 578:	78746b81 	ldrh	w1, [x28, x20]
 57c:	2a0003f7 	mov	w23, w0
 580:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_gf_mul>
 584:	91000a94 	add	x20, x20, #0x2
 588:	4a150015 	eor	w21, w0, w21
 58c:	f100829f 	cmp	x20, #0x20
 590:	54fffee1 	b.ne	56c <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x490>  // b.any
 594:	52800037 	mov	w23, #0x1                   	// #1
 598:	528001d4 	mov	w20, #0xe                   	// #14
 59c:	a9056bfb 	stp	x27, x26, [sp, #80]
 5a0:	9bd97f68 	umulh	x8, x27, x25
 5a4:	2a1603e0 	mov	w0, w22
 5a8:	d343fd08 	lsr	x8, x8, #3
 5ac:	9b187d08 	mul	x8, x8, x24
 5b0:	78686b41 	ldrh	w1, [x26, x8]
 ...
 5c8:	f1000694 	subs	x20, x20, #0x1
 5cc:	91000b5a 	add	x26, x26, #0x2
 5d0:	9100077b 	add	x27, x27, #0x1
 5d4:	54fffe61 	b.ne	5a0 <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x4c4>  // b.any
 5d8:	b9404fe9 	ldr	w9, [sp, #76]
 5dc:	2a1703e0 	mov	w0, w23
 5e0:	12003e68 	and	w8, w19, #0xffff
 5e4:	4b090114 	sub	w20, w8, w9
 ...
 5f8:	a9456bfb 	ldp	x27, x26, [sp, #80]
 5fc:	0a543c08 	and	w8, w0, w20, lsr #15
 600:	910a03e9 	add	x9, sp, #0x280
 604:	78337928 	strh	w8, [x9, x19, lsl #1]
 608:	91000673 	add	x19, x19, #0x1
 60c:	9100077b 	add	x27, x27, #0x1
 610:	f1003e7f 	cmp	x19, #0xf
 614:	91000b5a 	add	x26, x26, #0x2
 618:	54fff9c1 	b.ne	550 <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x474>  // b.any
 61c:	aa1f03e8 	mov	x8, xzr
 620:	2a1f03e9 	mov	w9, wzr
 624:	910483ea 	add	x10, sp, #0x120
 628:	910183eb 	add	x11, sp, #0x60
 62c:	910a03ec 	add	x12, sp, #0x280
 630:	f94007e2 	ldr	x2, [sp, #8]
 634:	38686950 	ldrb	w16, [x10, x8]
 638:	92403d31 	and	x17, x9, #0xffff
 63c:	7868796f 	ldrh	w15, [x11, x8, lsl #1]
 640:	aa1f03ee 	mov	x14, xzr
 644:	2a1f03ed 	mov	w13, wzr
 648:	d37ffa31 	lsl	x17, x17, #1
 64c:	7100021f 	cmp	w16, #0x0
 650:	786e6992 	ldrh	w18, [x12, x14]
 654:	1a9f07e0 	cset	w0, ne	// ne = any
 658:	eb0e023f 	cmp	x17, x14
 65c:	1a9f17e1 	cset	w1, eq	// eq = none
 660:	910009ce 	add	x14, x14, #0x2
 664:	6a010000 	ands	w0, w0, w1
 668:	1a9f1252 	csel	w18, w18, wzr, ne	// ne = any
 66c:	0b0001ad 	add	w13, w13, w0
 670:	0b0f024f 	add	w15, w18, w15
 674:	f10079df 	cmp	x14, #0x1e
 678:	54fffea1 	b.ne	64c <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x570>  // b.any
 67c:	7828796f 	strh	w15, [x11, x8, lsl #1]
 680:	0b0901a9 	add	w9, w13, w9
 684:	91000508 	add	x8, x8, #0x1
 688:	f100b91f 	cmp	x8, #0x2e
 68c:	54fffd41 	b.ne	634 <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x558>  // b.any
 690:	aa1f03e8 	mov	x8, xzr
 694:	910183e9 	add	x9, sp, #0x60
 698:	7868792a 	ldrh	w10, [x9, x8, lsl #1]
 69c:	3868684b 	ldrb	w11, [x2, x8]
 6a0:	4a0a016a 	eor	w10, w11, w10
 6a4:	3828684a 	strb	w10, [x2, x8]
 6a8:	91000508 	add	x8, x8, #0x1
 6ac:	f100b91f 	cmp	x8, #0x2e
 6b0:	54ffff41 	b.ne	698 <PQCLEAN_HQC128_CLEAN_reed_solomon_decode+0x5bc>  // b.any
 6b4:	3cc1e040 	ldur	q0, [x2, #30]
 6b8:	f9400be8 	ldr	x8, [sp, #16]
 6bc:	3d800100 	str	q0, [x8]
 6c0:	9112c3ff 	add	sp, sp, #0x4b0
 6c4:	a9454ff4 	ldp	x20, x19, [sp, #80]
 6c8:	a94457f6 	ldp	x22, x21, [sp, #64]
 6cc:	a9435ff8 	ldp	x24, x23, [sp, #48]
 6d0:	a94267fa 	ldp	x26, x25, [sp, #32]
 6d4:	a9416ffc 	ldp	x28, x27, [sp, #16]
 6d8:	a8c67bfd 	ldp	x29, x30, [sp], #96
 6dc:	d65f03c0 	ret
