...
class WorkBench:
    ...
    def write_buffer(self, array,blocking=True):
        ...
        for byte in array_b:
            ...
            if it == 64:
                ...
                it = 0
        if blocking:
            while self.target.in_waiting_tx() != 0:
                pass
                
    def in_waiting_tx(self):
        return self.target.in_waiting_tx()
    ...
    def wait_trigger_low(self):
        while self.scope.adc.state == True:
            pass
