...
/tmp/gf.clang-19.O0.o:     file format elf64-littleaarch64
...
000000000000028c <gf_reduce>:
 ...
 324:	9400007f 	bl	520 <trailing_zero_bits_count>
...
00000000000003bc <PQCLEAN_HQC128_CLEAN_gf_square>:
 ...
 3f4:	54000282 	b.cs	444 <PQCLEAN_HQC128_CLEAN_gf_square+0x88>  // b.hs, b.nlast
 3f8:	14000001 	b	3fc <PQCLEAN_HQC128_CLEAN_gf_square+0x40>
 3fc:	b85f83a8 	ldur	w8, [x29, #-8]
 400:	52800029 	mov	w9, #0x1                   	// #1
 404:	531f7908 	lsl	w8, w8, #1
 408:	b81f83a8 	stur	w8, [x29, #-8]
 40c:	b85f83a8 	ldur	w8, [x29, #-8]
 410:	f94007eb 	ldr	x11, [sp, #8]
 414:	d280004a 	mov	x10, #0x2                   	// #2
 418:	9b0b7d4a 	mul	x10, x10, x11
 41c:	1aca2129 	lsl	w9, w9, w10
 420:	0a090109 	and	w9, w8, w9
 424:	b85f43a8 	ldur	w8, [x29, #-12]
 428:	4a090108 	eor	w8, w8, w9
 42c:	b81f43a8 	stur	w8, [x29, #-12]
 430:	14000001 	b	434 <PQCLEAN_HQC128_CLEAN_gf_square+0x78>
 434:	f94007e8 	ldr	x8, [sp, #8]
 438:	91000508 	add	x8, x8, #0x1
 43c:	f90007e8 	str	x8, [sp, #8]
 440:	17ffffeb 	b	3ec <PQCLEAN_HQC128_CLEAN_gf_square+0x30>
 444:	b85f43a8 	ldur	w8, [x29, #-12]
 448:	2a0803e0 	mov	w0, w8
 44c:	d28001c1 	mov	x1, #0xe                   	// #14
 450:	97ffff8f 	bl	28c <gf_reduce>
 454:	a9427bfd 	ldp	x29, x30, [sp, #32]
 458:	9100c3ff 	add	sp, sp, #0x30
 45c:	d65f03c0 	ret

0000000000000460 <PQCLEAN_HQC128_CLEAN_gf_inverse>:
 460:	d10083ff 	sub	sp, sp, #0x20
 464:	a9017bfd 	stp	x29, x30, [sp, #16]
 468:	910043fd 	add	x29, sp, #0x10
 46c:	781fe3a0 	sturh	w0, [x29, #-2]
 470:	785fe3a8 	ldurh	w8, [x29, #-2]
 474:	781fc3a8 	sturh	w8, [x29, #-4]
 478:	785fe3a0 	ldurh	w0, [x29, #-2]
 47c:	94000000 	bl	3bc <PQCLEAN_HQC128_CLEAN_gf_square>
 480:	781fc3a0 	sturh	w0, [x29, #-4]
 484:	785fc3a0 	ldurh	w0, [x29, #-4]
 488:	785fe3a1 	ldurh	w1, [x29, #-2]
 48c:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_gf_mul>
 490:	781fa3a0 	sturh	w0, [x29, #-6]
 494:	785fc3a0 	ldurh	w0, [x29, #-4]
 498:	94000000 	bl	3bc <PQCLEAN_HQC128_CLEAN_gf_square>
 49c:	781fc3a0 	sturh	w0, [x29, #-4]
 4a0:	785fc3a0 	ldurh	w0, [x29, #-4]
 4a4:	785fa3a1 	ldurh	w1, [x29, #-6]
 4a8:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_gf_mul>
 4ac:	790013e0 	strh	w0, [sp, #8]
 4b0:	785fc3a0 	ldurh	w0, [x29, #-4]
 4b4:	794013e1 	ldrh	w1, [sp, #8]
 4b8:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_gf_mul>
 4bc:	781fa3a0 	sturh	w0, [x29, #-6]
 4c0:	785fa3a0 	ldurh	w0, [x29, #-6]
 4c4:	785fc3a1 	ldurh	w1, [x29, #-4]
 4c8:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_gf_mul>
 4cc:	781fc3a0 	sturh	w0, [x29, #-4]
 4d0:	785fc3a0 	ldurh	w0, [x29, #-4]
 4d4:	94000000 	bl	3bc <PQCLEAN_HQC128_CLEAN_gf_square>
 4d8:	781fc3a0 	sturh	w0, [x29, #-4]
 4dc:	785fc3a0 	ldurh	w0, [x29, #-4]
 4e0:	94000000 	bl	3bc <PQCLEAN_HQC128_CLEAN_gf_square>
 4e4:	781fc3a0 	sturh	w0, [x29, #-4]
 4e8:	785fc3a0 	ldurh	w0, [x29, #-4]
 4ec:	94000000 	bl	3bc <PQCLEAN_HQC128_CLEAN_gf_square>
 4f0:	781fc3a0 	sturh	w0, [x29, #-4]
 4f4:	785fc3a0 	ldurh	w0, [x29, #-4]
 4f8:	794013e1 	ldrh	w1, [sp, #8]
 4fc:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_gf_mul>
 500:	781fc3a0 	sturh	w0, [x29, #-4]
 504:	785fc3a0 	ldurh	w0, [x29, #-4]
 508:	94000000 	bl	3bc <PQCLEAN_HQC128_CLEAN_gf_square>
 50c:	781fc3a0 	sturh	w0, [x29, #-4]
 510:	785fc3a0 	ldurh	w0, [x29, #-4]
 514:	a9417bfd 	ldp	x29, x30, [sp, #16]
 518:	910083ff 	add	sp, sp, #0x20
 51c:	d65f03c0 	ret

0000000000000520 <trailing_zero_bits_count>:
 520:	d10043ff 	sub	sp, sp, #0x10
 524:	79001fe0 	strh	w0, [sp, #14]
 528:	79001bff 	strh	wzr, [sp, #12]
 52c:	529fffe8 	mov	w8, #0xffff                	// #65535
 530:	790017e8 	strh	w8, [sp, #10]
 534:	f90003ff 	str	xzr, [sp]
 538:	14000001 	b	53c <trailing_zero_bits_count+0x1c>
 53c:	f94003e8 	ldr	x8, [sp]
 540:	f1003908 	subs	x8, x8, #0xe
 544:	54000382 	b.cs	5b4 <trailing_zero_bits_count+0x94>  // b.hs, b.nlast
 548:	14000001 	b	54c <trailing_zero_bits_count+0x2c>
 54c:	79401fe8 	ldrh	w8, [sp, #14]
 550:	f94003e9 	ldr	x9, [sp]
 554:	1ac92909 	asr	w9, w8, w9
 558:	52800028 	mov	w8, #0x1                   	// #1
 55c:	12000129 	and	w9, w9, #0x1
 560:	6b090109 	subs	w9, w8, w9
 564:	794017ea 	ldrh	w10, [sp, #10]
 568:	0a0a012a 	and	w10, w9, w10
 56c:	79401be9 	ldrh	w9, [sp, #12]
 570:	0b0a0129 	add	w9, w9, w10
 574:	79001be9 	strh	w9, [sp, #12]
 578:	79401fe9 	ldrh	w9, [sp, #14]
 57c:	f94003ea 	ldr	x10, [sp]
 580:	1aca2929 	asr	w9, w9, w10
 584:	12000129 	and	w9, w9, #0x1
 588:	6b090109 	subs	w9, w8, w9
 58c:	2a1f03e8 	mov	w8, wzr
 590:	6b090109 	subs	w9, w8, w9
 594:	794017e8 	ldrh	w8, [sp, #10]
 598:	0a090108 	and	w8, w8, w9
 59c:	790017e8 	strh	w8, [sp, #10]
 5a0:	14000001 	b	5a4 <trailing_zero_bits_count+0x84>
 5a4:	f94003e8 	ldr	x8, [sp]
 5a8:	91000508 	add	x8, x8, #0x1
 5ac:	f90003e8 	str	x8, [sp]
 5b0:	17ffffe3 	b	53c <trailing_zero_bits_count+0x1c>
 5b4:	79401be0 	ldrh	w0, [sp, #12]
