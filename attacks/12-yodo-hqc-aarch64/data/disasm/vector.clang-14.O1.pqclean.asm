...
/tmp/vector.clang-14.O1.o:     file format elf64-littleaarch64
...
00000000000002ac <PQCLEAN_HQC128_CLEAN_vect_set_random>:
 ...
 2b8:	a9024ff4 	stp	x20, x19, [sp, #32]
...
0000000000000374 <PQCLEAN_HQC128_CLEAN_vect_resize>:
 ...
 388:	540002a2 	b.cs	3dc <PQCLEAN_HQC128_CLEAN_vect_resize+0x68>  // b.hs, b.nlast
 ...
 3b0:	34000254 	cbz	w20, 3f8 <PQCLEAN_HQC128_CLEAN_vect_resize+0x84>
 ...
 3d8:	14000008 	b	3f8 <PQCLEAN_HQC128_CLEAN_vect_resize+0x84>
 3dc:	1100fc68 	add	w8, w3, #0x3f
 3e0:	aa1303e0 	mov	x0, x19
 3e4:	53037d08 	lsr	w8, w8, #3
 3e8:	aa0203e1 	mov	x1, x2
 3ec:	121d6508 	and	w8, w8, #0x1ffffff8
 3f0:	aa0803e2 	mov	x2, x8
 3f4:	94000000 	bl	0 <memcpy>
 3f8:	a9414ff4 	ldp	x20, x19, [sp, #16]
 3fc:	a8c27bfd 	ldp	x29, x30, [sp], #32
 400:	d65f03c0 	ret
