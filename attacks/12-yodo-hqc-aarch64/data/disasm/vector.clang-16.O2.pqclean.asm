...
/tmp/vector.clang-16.O2.o:     file format elf64-littleaarch64
...
0000000000000000 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight>:
 ...
 570:	54000300 	b.eq	5d0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x5d0>  // b.none
 ...
 5d0:	910983ea 	add	x10, sp, #0x260
 5d4:	910023eb 	add	x11, sp, #0x8
 5d8:	aa1f03e8 	mov	x8, xzr
 5dc:	927d32c9 	and	x9, x22, #0xfff8
 5e0:	9100414c 	add	x12, x10, #0x10
 5e4:	9100816d 	add	x13, x11, #0x20
 5e8:	14000009 	b	60c <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x60c>
 5ec:	aa1f03ee 	mov	x14, xzr
 5f0:	d37df10f 	lsl	x15, x8, #3
 5f4:	91000508 	add	x8, x8, #0x1
 5f8:	f104551f 	cmp	x8, #0x115
 5fc:	f86f6a90 	ldr	x16, [x20, x15]
 600:	aa0e020e 	orr	x14, x16, x14
 604:	f82f6a8e 	str	x14, [x20, x15]
 608:	54000720 	b.eq	6ec <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x6ec>  // b.none
 60c:	72003e7f 	tst	w19, #0xffff
 610:	54fffee0 	b.eq	5ec <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x5ec>  // b.none
 614:	12003e6e 	and	w14, w19, #0xffff
 618:	710021df 	cmp	w14, #0x8
 61c:	54000082 	b.cs	62c <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x62c>  // b.hs, b.nlast
 620:	aa1f03f1 	mov	x17, xzr
 624:	aa1f03ee 	mov	x14, xzr
 628:	14000026 	b	6c0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x6c0>
 62c:	6f00e400 	movi	v0.2d, #0x0
 630:	aa0903ee 	mov	x14, x9
 634:	6f00e401 	movi	v1.2d, #0x0
 638:	aa0d03ef 	mov	x15, x13
 63c:	6f00e402 	movi	v2.2d, #0x0
 640:	aa0c03f0 	mov	x16, x12
 644:	6f00e403 	movi	v3.2d, #0x0
 648:	4e040d04 	dup	v4.4s, w8
 64c:	ad7f9a05 	ldp	q5, q6, [x16, #-16]
 650:	91008210 	add	x16, x16, #0x20
 654:	f10021ce 	subs	x14, x14, #0x8
 658:	6ea48ca5 	cmeq	v5.4s, v5.4s, v4.4s
 65c:	ad7f1df0 	ldp	q16, q7, [x15, #-32]
 660:	6ea48cc6 	cmeq	v6.4s, v6.4s, v4.4s
 664:	4f20a4b3 	sxtl2	v19.2d, v5.4s
 668:	0f20a4a5 	sxtl	v5.2d, v5.2s
 66c:	4f20a4d4 	sxtl2	v20.2d, v6.4s
 670:	0f20a4c6 	sxtl	v6.2d, v6.2s
 674:	acc245f2 	ldp	q18, q17, [x15], #64
 678:	4e251e05 	and	v5.16b, v16.16b, v5.16b
 67c:	4e331ce7 	and	v7.16b, v7.16b, v19.16b
 680:	4e261e46 	and	v6.16b, v18.16b, v6.16b
 684:	4ea11ce1 	orr	v1.16b, v7.16b, v1.16b
 688:	4e341e30 	and	v16.16b, v17.16b, v20.16b
 ...
 6a0:	aa0903f1 	mov	x17, x9
 6a4:	4ea11c61 	orr	v1.16b, v3.16b, v1.16b
 6a8:	eb16013f 	cmp	x9, x22
 6ac:	4ea11c00 	orr	v0.16b, v0.16b, v1.16b
 6b0:	6e004001 	ext	v1.16b, v0.16b, v0.16b, #8
 6b4:	0ea11c00 	orr	v0.8b, v0.8b, v1.8b
 6b8:	9e66000e 	fmov	x14, d0
 6bc:	54fff9a0 	b.eq	5f0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x5f0>  // b.none
 6c0:	cb1102cf 	sub	x15, x22, x17
 6c4:	8b110d70 	add	x16, x11, x17, lsl #3
 6c8:	8b110951 	add	x17, x10, x17, lsl #2
 6cc:	b8404632 	ldr	w18, [x17], #4
 6d0:	f8408600 	ldr	x0, [x16], #8
 6d4:	6b08025f 	cmp	w18, w8
 6d8:	9a9f0012 	csel	x18, x0, xzr, eq	// eq = none
 6dc:	f10005ef 	subs	x15, x15, #0x1
 6e0:	aa0e024e 	orr	x14, x18, x14
 6e4:	54ffff41 	b.ne	6cc <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x6cc>  // b.any
 6e8:	17ffffc2 	b	5f0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x5f0>
 6ec:	9117c3ff 	add	sp, sp, #0x5f0
 6f0:	a9444ff4 	ldp	x20, x19, [sp, #64]
 6f4:	a94357f6 	ldp	x22, x21, [sp, #48]
 6f8:	a9425ff8 	ldp	x24, x23, [sp, #32]
 6fc:	a940fbfd 	ldp	x29, x30, [sp, #8]
 700:	f9400ffc 	ldr	x28, [sp, #24]
 704:	fc4507e8 	ldr	d8, [sp], #80
 708:	d65f03c0 	ret
...
000000000000077c <PQCLEAN_HQC128_CLEAN_vect_add>:
 77c:	b4000503 	cbz	x3, 81c <PQCLEAN_HQC128_CLEAN_vect_add+0xa0>
 780:	f100187f 	cmp	x3, #0x6
 784:	54000062 	b.cs	790 <PQCLEAN_HQC128_CLEAN_vect_add+0x14>  // b.hs, b.nlast
 788:	aa1f03e8 	mov	x8, xzr
 78c:	14000019 	b	7f0 <PQCLEAN_HQC128_CLEAN_vect_add+0x74>
 790:	aa1f03e8 	mov	x8, xzr
 794:	cb010009 	sub	x9, x0, x1
 798:	f100813f 	cmp	x9, #0x20
 79c:	540002a3 	b.cc	7f0 <PQCLEAN_HQC128_CLEAN_vect_add+0x74>  // b.lo, b.ul, b.last
 7a0:	cb020009 	sub	x9, x0, x2
 7a4:	f100813f 	cmp	x9, #0x20
 7a8:	54000243 	b.cc	7f0 <PQCLEAN_HQC128_CLEAN_vect_add+0x74>  // b.lo, b.ul, b.last
 7ac:	927ef468 	and	x8, x3, #0xfffffffffffffffc
 7b0:	91004029 	add	x9, x1, #0x10
 7b4:	9100404a 	add	x10, x2, #0x10
 7b8:	9100400b 	add	x11, x0, #0x10
 7bc:	aa0803ec 	mov	x12, x8
 7c0:	ad7f8520 	ldp	q0, q1, [x9, #-16]
 7c4:	91008129 	add	x9, x9, #0x20
 7c8:	f100118c 	subs	x12, x12, #0x4
 7cc:	ad7f8d42 	ldp	q2, q3, [x10, #-16]
 7d0:	9100814a 	add	x10, x10, #0x20
 7d4:	6e201c40 	eor	v0.16b, v2.16b, v0.16b
 7d8:	6e211c61 	eor	v1.16b, v3.16b, v1.16b
 7dc:	ad3f8560 	stp	q0, q1, [x11, #-16]
 7e0:	9100816b 	add	x11, x11, #0x20
 7e4:	54fffee1 	b.ne	7c0 <PQCLEAN_HQC128_CLEAN_vect_add+0x44>  // b.any
 7e8:	eb03011f 	cmp	x8, x3
 7ec:	54000180 	b.eq	81c <PQCLEAN_HQC128_CLEAN_vect_add+0xa0>  // b.none
 7f0:	d37df10b 	lsl	x11, x8, #3
 7f4:	cb080068 	sub	x8, x3, x8
 7f8:	8b0b0009 	add	x9, x0, x11
 7fc:	8b0b004a 	add	x10, x2, x11
 800:	8b0b002b 	add	x11, x1, x11
 804:	f840856c 	ldr	x12, [x11], #8
 808:	f840854d 	ldr	x13, [x10], #8
 80c:	f1000508 	subs	x8, x8, #0x1
 810:	ca0c01ac 	eor	x12, x13, x12
 814:	f800852c 	str	x12, [x9], #8
 818:	54ffff61 	b.ne	804 <PQCLEAN_HQC128_CLEAN_vect_add+0x88>  // b.any
 81c:	d65f03c0 	ret
...
0000000000000820 <PQCLEAN_HQC128_CLEAN_vect_compare>:
 ...
 834:	1400004a 	b	95c <PQCLEAN_HQC128_CLEAN_vect_compare+0x13c>
 ...
 850:	1400002a 	b	8f8 <PQCLEAN_HQC128_CLEAN_vect_compare+0xd8>
 854:	9000000a 	adrp	x10, 0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight>
 858:	927be848 	and	x8, x2, #0xffffffffffffffe0
 85c:	6f00e400 	movi	v0.2d, #0x0
 860:	91004009 	add	x9, x0, #0x10
 864:	6f00e401 	movi	v1.2d, #0x0
 868:	aa0803eb 	mov	x11, x8
 86c:	6f00e402 	movi	v2.2d, #0x0
 870:	3dc00143 	ldr	q3, [x10]
 874:	9100402a 	add	x10, x1, #0x10
 878:	ad7f9524 	ldp	q4, q5, [x9, #-16]
 87c:	91008129 	add	x9, x9, #0x20
 880:	f100816b 	subs	x11, x11, #0x20
 884:	ad7f9d46 	ldp	q6, q7, [x10, #-16]
 888:	9100814a 	add	x10, x10, #0x20
 88c:	6e241cc4 	eor	v4.16b, v6.16b, v4.16b
 890:	2f08a486 	uxtl	v6.8h, v4.8b
 894:	6e251ce5 	eor	v5.16b, v7.16b, v5.16b
 898:	6f08a484 	uxtl2	v4.8h, v4.16b
 89c:	2f08a4a7 	uxtl	v7.8h, v5.8b
 8a0:	6f08a4a5 	uxtl2	v5.8h, v5.16b
 8a4:	4ea41c00 	orr	v0.16b, v0.16b, v4.16b
 8a8:	4ea61c63 	orr	v3.16b, v3.16b, v6.16b
 8ac:	4ea51c42 	orr	v2.16b, v2.16b, v5.16b
 ...
 8d0:	0e063c09 	umov	w9, v0.h[1]
 8d4:	0e023c0a 	umov	w10, v0.h[0]
 8d8:	0e0a3c0b 	umov	w11, v0.h[2]
 8dc:	0e0e3c0c 	umov	w12, v0.h[3]
 8e0:	2a090149 	orr	w9, w10, w9
 8e4:	2a0c016a 	orr	w10, w11, w12
 8e8:	2a0a0129 	orr	w9, w9, w10
 8ec:	540004a0 	b.eq	980 <PQCLEAN_HQC128_CLEAN_vect_compare+0x160>  // b.none
 8f0:	f27d045f 	tst	x2, #0x18
 8f4:	54000340 	b.eq	95c <PQCLEAN_HQC128_CLEAN_vect_compare+0x13c>  // b.none
 8f8:	6f00e400 	movi	v0.2d, #0x0
 8fc:	aa0803eb 	mov	x11, x8
 900:	927df048 	and	x8, x2, #0xfffffffffffffff8
 904:	8b0b002a 	add	x10, x1, x11
 908:	4e021d20 	mov	v0.h[0], w9
 90c:	8b0b0009 	add	x9, x0, x11
 910:	cb08016b 	sub	x11, x11, x8
 914:	fc408521 	ldr	d1, [x9], #8
 918:	fc408542 	ldr	d2, [x10], #8
 91c:	b100216b 	adds	x11, x11, #0x8
 920:	2e211c41 	eor	v1.8b, v2.8b, v1.8b
 924:	2f08a421 	uxtl	v1.8h, v1.8b
 928:	4ea11c00 	orr	v0.16b, v0.16b, v1.16b
 92c:	54ffff41 	b.ne	914 <PQCLEAN_HQC128_CLEAN_vect_compare+0xf4>  // b.any
 930:	6e004001 	ext	v1.16b, v0.16b, v0.16b, #8
 934:	eb02011f 	cmp	x8, x2
 938:	0ea11c00 	orr	v0.8b, v0.8b, v1.8b
 93c:	0e063c09 	umov	w9, v0.h[1]
 940:	0e023c0a 	umov	w10, v0.h[0]
 944:	0e0a3c0b 	umov	w11, v0.h[2]
 948:	0e0e3c0c 	umov	w12, v0.h[3]
 94c:	2a090149 	orr	w9, w10, w9
 950:	2a0c016a 	orr	w10, w11, w12
 954:	2a0a0129 	orr	w9, w9, w10
 958:	54000140 	b.eq	980 <PQCLEAN_HQC128_CLEAN_vect_compare+0x160>  // b.none
 95c:	cb08004a 	sub	x10, x2, x8
 960:	8b08002b 	add	x11, x1, x8
 964:	8b080008 	add	x8, x0, x8
 968:	3840150c 	ldrb	w12, [x8], #1
 96c:	3840156d 	ldrb	w13, [x11], #1
 970:	f100054a 	subs	x10, x10, #0x1
 974:	4a0c01ac 	eor	w12, w13, w12
 978:	2a0c0129 	orr	w9, w9, w12
 97c:	54ffff61 	b.ne	968 <PQCLEAN_HQC128_CLEAN_vect_compare+0x148>  // b.any
 980:	529fffe8 	mov	w8, #0xffff                	// #65535
 984:	0b292108 	add	w8, w8, w9, uxth
 988:	53087d00 	lsr	w0, w8, #8
 98c:	d65f03c0 	ret

0000000000000990 <PQCLEAN_HQC128_CLEAN_vect_resize>:
 990:	a9be7bfd 	stp	x29, x30, [sp, #-32]!
 994:	a9014ff4 	stp	x20, x19, [sp, #16]
 998:	910003fd 	mov	x29, sp
 99c:	aa0003f3 	mov	x19, x0
 9a0:	6b03003f 	cmp	w1, w3
 9a4:	54000202 	b.cs	9e4 <PQCLEAN_HQC128_CLEAN_vect_resize+0x54>  // b.hs, b.nlast
 9a8:	72001428 	ands	w8, w1, #0x3f
 9ac:	aa1303e0 	mov	x0, x19
 9b0:	7200143f 	tst	w1, #0x3f
 9b4:	aa0203e1 	mov	x1, x2
 9b8:	52811402 	mov	w2, #0x8a0                 	// #2208
 9bc:	52800809 	mov	w9, #0x40                  	// #64
 9c0:	4b080128 	sub	w8, w9, w8
 9c4:	1a8803f4 	csel	w20, wzr, w8, eq	// eq = none
 9c8:	94000000 	bl	0 <memcpy>
 9cc:	34000574 	cbz	w20, a78 <PQCLEAN_HQC128_CLEAN_vect_resize+0xe8>
 9d0:	f9444e69 	ldr	x9, [x19, #2200]
 9d4:	7100069f 	cmp	w20, #0x1
 9d8:	54000181 	b.ne	a08 <PQCLEAN_HQC128_CLEAN_vect_resize+0x78>  // b.any
 9dc:	aa1f03e8 	mov	x8, xzr
 9e0:	1400001f 	b	a5c <PQCLEAN_HQC128_CLEAN_vect_resize+0xcc>
 9e4:	1100fc68 	add	w8, w3, #0x3f
 9e8:	aa1303e0 	mov	x0, x19
 9ec:	53037d08 	lsr	w8, w8, #3
 9f0:	aa0203e1 	mov	x1, x2
 9f4:	121d6508 	and	w8, w8, #0x1ffffff8
 9f8:	aa0803e2 	mov	x2, x8
 9fc:	a9414ff4 	ldp	x20, x19, [sp, #16]
 a00:	a8c27bfd 	ldp	x29, x30, [sp], #32
 a04:	14000000 	b	0 <memcpy>
 a08:	6f07e7e0 	movi	v0.2d, #0xffffffffffffffff
 a0c:	9000000a 	adrp	x10, 0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight>
 a10:	92f0000b 	mov	x11, #0x7fffffffffffffff    	// #9223372036854775807
 a14:	5280004c 	mov	w12, #0x2                   	// #2
 a18:	927f1688 	and	x8, x20, #0x7e
 a1c:	3dc00141 	ldr	q1, [x10]
 a20:	4e081d20 	mov	v0.d[0], x9
 a24:	aa0803e9 	mov	x9, x8
 a28:	4e080d62 	dup	v2.2d, x11
 a2c:	4e080d83 	dup	v3.2d, x12
 a30:	6ee0b824 	neg	v4.2d, v1.2d
 a34:	f1000929 	subs	x9, x9, #0x2
 a38:	4ee38421 	add	v1.2d, v1.2d, v3.2d
 a3c:	6ee44444 	ushl	v4.2d, v2.2d, v4.2d
 a40:	4e241c00 	and	v0.16b, v0.16b, v4.16b
 a44:	54ffff61 	b.ne	a30 <PQCLEAN_HQC128_CLEAN_vect_resize+0xa0>  // b.any
 a48:	6e004001 	ext	v1.16b, v0.16b, v0.16b, #8
 a4c:	eb14011f 	cmp	x8, x20
 a50:	0e211c00 	and	v0.8b, v0.8b, v1.8b
 a54:	9e660009 	fmov	x9, d0
 a58:	540000e0 	b.eq	a74 <PQCLEAN_HQC128_CLEAN_vect_resize+0xe4>  // b.none
 a5c:	92f0000a 	mov	x10, #0x7fffffffffffffff    	// #9223372036854775807
 a60:	9ac8254b 	lsr	x11, x10, x8
 a64:	91000508 	add	x8, x8, #0x1
 a68:	8a0b0129 	and	x9, x9, x11
 a6c:	eb08029f 	cmp	x20, x8
 a70:	54ffff81 	b.ne	a60 <PQCLEAN_HQC128_CLEAN_vect_resize+0xd0>  // b.any
 a74:	f9044e69 	str	x9, [x19, #2200]
 a78:	a9414ff4 	ldp	x20, x19, [sp, #16]
 a7c:	a8c27bfd 	ldp	x29, x30, [sp], #32
 a80:	d65f03c0 	ret
