...
/tmp/vector.clang-19.O2.o:     file format elf64-littleaarch64
...
0000000000000000 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight>:
 ...
 578:	540002e0 	b.eq	5d4 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x5d4>  // b.none
 ...
 5d4:	910983ea 	add	x10, sp, #0x260
 5d8:	910023eb 	add	x11, sp, #0x8
 5dc:	aa1f03e9 	mov	x9, xzr
 5e0:	927d310c 	and	x12, x8, #0xfff8
 5e4:	9100414d 	add	x13, x10, #0x10
 5e8:	9100816e 	add	x14, x11, #0x20
 5ec:	14000008 	b	60c <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x60c>
 5f0:	aa1f03ef 	mov	x15, xzr
 5f4:	f8697a90 	ldr	x16, [x20, x9, lsl #3]
 5f8:	aa0f020f 	orr	x15, x16, x15
 5fc:	f8297a8f 	str	x15, [x20, x9, lsl #3]
 600:	91000529 	add	x9, x9, #0x1
 604:	f104553f 	cmp	x9, #0x115
 608:	54000720 	b.eq	6ec <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x6ec>  // b.none
 60c:	72003e7f 	tst	w19, #0xffff
 610:	54ffff00 	b.eq	5f0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x5f0>  // b.none
 614:	12003e6f 	and	w15, w19, #0xffff
 618:	71001dff 	cmp	w15, #0x7
 61c:	54000088 	b.hi	62c <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x62c>  // b.pmore
 620:	aa1f03f2 	mov	x18, xzr
 624:	aa1f03ef 	mov	x15, xzr
 628:	14000026 	b	6c0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x6c0>
 62c:	6f00e400 	movi	v0.2d, #0x0
 630:	6f00e401 	movi	v1.2d, #0x0
 634:	aa0c03ef 	mov	x15, x12
 638:	6f00e402 	movi	v2.2d, #0x0
 63c:	6f00e403 	movi	v3.2d, #0x0
 640:	aa0e03f0 	mov	x16, x14
 644:	4e040d24 	dup	v4.4s, w9
 648:	aa0d03f1 	mov	x17, x13
 64c:	ad7f9a25 	ldp	q5, q6, [x17, #-16]
 650:	f10021ef 	subs	x15, x15, #0x8
 654:	ad7f4612 	ldp	q18, q17, [x16, #-32]
 658:	91008231 	add	x17, x17, #0x20
 65c:	acc24e14 	ldp	q20, q19, [x16], #64
 660:	6ea48ca5 	cmeq	v5.4s, v5.4s, v4.4s
 664:	6ea48cc6 	cmeq	v6.4s, v6.4s, v4.4s
 668:	4f20a4a7 	sxtl2	v7.2d, v5.4s
 66c:	0f20a4a5 	sxtl	v5.2d, v5.2s
 670:	4f20a4d0 	sxtl2	v16.2d, v6.4s
 674:	0f20a4c6 	sxtl	v6.2d, v6.2s
 678:	4e271e27 	and	v7.16b, v17.16b, v7.16b
 67c:	4e251e45 	and	v5.16b, v18.16b, v5.16b
 680:	4e301e70 	and	v16.16b, v19.16b, v16.16b
 684:	4e261e86 	and	v6.16b, v20.16b, v6.16b
 688:	4ea11ce1 	orr	v1.16b, v7.16b, v1.16b
 68c:	4ea01ca0 	orr	v0.16b, v5.16b, v0.16b
 690:	4ea31e03 	orr	v3.16b, v16.16b, v3.16b
 694:	4ea21cc2 	orr	v2.16b, v6.16b, v2.16b
 698:	54fffda1 	b.ne	64c <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x64c>  // b.any
 69c:	4ea01c40 	orr	v0.16b, v2.16b, v0.16b
 6a0:	4ea11c61 	orr	v1.16b, v3.16b, v1.16b
 6a4:	eb08019f 	cmp	x12, x8
 6a8:	aa0c03f2 	mov	x18, x12
 6ac:	4ea11c00 	orr	v0.16b, v0.16b, v1.16b
 6b0:	6e004001 	ext	v1.16b, v0.16b, v0.16b, #8
 6b4:	0ea11c00 	orr	v0.8b, v0.8b, v1.8b
 6b8:	9e66000f 	fmov	x15, d0
 6bc:	54fff9c0 	b.eq	5f4 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x5f4>  // b.none
 6c0:	8b120d70 	add	x16, x11, x18, lsl #3
 6c4:	8b120951 	add	x17, x10, x18, lsl #2
 6c8:	cb120112 	sub	x18, x8, x18
 6cc:	b8404620 	ldr	w0, [x17], #4
 6d0:	f8408601 	ldr	x1, [x16], #8
 6d4:	6b09001f 	cmp	w0, w9
 6d8:	9a9f0020 	csel	x0, x1, xzr, eq	// eq = none
 6dc:	f1000652 	subs	x18, x18, #0x1
 6e0:	aa0f000f 	orr	x15, x0, x15
 6e4:	54ffff41 	b.ne	6cc <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x6cc>  // b.any
 6e8:	17ffffc3 	b	5f4 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight+0x5f4>
 6ec:	9117c3ff 	add	sp, sp, #0x5f0
 6f0:	a9464ff4 	ldp	x20, x19, [sp, #96]
 6f4:	a94557f6 	ldp	x22, x21, [sp, #80]
 6f8:	a9445ffc 	ldp	x28, x23, [sp, #64]
 6fc:	a9437bfd 	ldp	x29, x30, [sp, #48]
 700:	6d4223e9 	ldp	d9, d8, [sp, #32]
 704:	6d412beb 	ldp	d11, d10, [sp, #16]
 708:	6cc733ed 	ldp	d13, d12, [sp], #112
 70c:	d65f03c0 	ret

0000000000000710 <PQCLEAN_HQC128_CLEAN_vect_set_random>:
 710:	a9bd7bfd 	stp	x29, x30, [sp, #-48]!
 714:	f9000bfc 	str	x28, [sp, #16]
 718:	a9024ff4 	stp	x20, x19, [sp, #32]
 71c:	910003fd 	mov	x29, sp
 720:	d122c3ff 	sub	sp, sp, #0x8b0
 724:	aa0103f3 	mov	x19, x1
 728:	aa0003f4 	mov	x20, x0
 72c:	91003fe0 	add	x0, sp, #0xf
 730:	2a1f03e1 	mov	w1, wzr
 734:	52811422 	mov	w2, #0x8a1                 	// #2209
 738:	94000000 	bl	0 <memset>
 73c:	91003fe1 	add	x1, sp, #0xf
 740:	aa1403e0 	mov	x0, x20
 744:	52811422 	mov	w2, #0x8a1                 	// #2209
 748:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_seedexpander>
 74c:	91003fe2 	add	x2, sp, #0xf
 750:	aa1303e0 	mov	x0, x19
 754:	528022a1 	mov	w1, #0x115                 	// #277
 758:	52811423 	mov	w3, #0x8a1                 	// #2209
 75c:	94000000 	bl	0 <PQCLEAN_HQC128_CLEAN_load8_arr>
 760:	f9445268 	ldr	x8, [x19, #2208]
 764:	92401108 	and	x8, x8, #0x1f
 768:	f9045268 	str	x8, [x19, #2208]
 76c:	9122c3ff 	add	sp, sp, #0x8b0
 770:	a9424ff4 	ldp	x20, x19, [sp, #32]
 774:	f9400bfc 	ldr	x28, [sp, #16]
 778:	a8c37bfd 	ldp	x29, x30, [sp], #48
 77c:	d65f03c0 	ret

0000000000000780 <PQCLEAN_HQC128_CLEAN_vect_add>:
 780:	b40001e3 	cbz	x3, 7bc <PQCLEAN_HQC128_CLEAN_vect_add+0x3c>
 784:	f100147f 	cmp	x3, #0x5
 788:	540001c8 	b.hi	7c0 <PQCLEAN_HQC128_CLEAN_vect_add+0x40>  // b.pmore
 78c:	aa1f03e8 	mov	x8, xzr
 790:	d37df10b 	lsl	x11, x8, #3
 794:	cb080068 	sub	x8, x3, x8
 798:	8b0b0009 	add	x9, x0, x11
 79c:	8b0b004a 	add	x10, x2, x11
 7a0:	8b0b002b 	add	x11, x1, x11
 7a4:	f840856c 	ldr	x12, [x11], #8
 7a8:	f1000508 	subs	x8, x8, #0x1
 7ac:	f840854d 	ldr	x13, [x10], #8
 7b0:	ca0c01ac 	eor	x12, x13, x12
 7b4:	f800852c 	str	x12, [x9], #8
 7b8:	54ffff61 	b.ne	7a4 <PQCLEAN_HQC128_CLEAN_vect_add+0x24>  // b.any
 7bc:	d65f03c0 	ret
 7c0:	cb010008 	sub	x8, x0, x1
 7c4:	f100811f 	cmp	x8, #0x20
 7c8:	aa1f03e8 	mov	x8, xzr
 7cc:	54fffe23 	b.cc	790 <PQCLEAN_HQC128_CLEAN_vect_add+0x10>  // b.lo, b.ul, b.last
 7d0:	cb020009 	sub	x9, x0, x2
 7d4:	f100813f 	cmp	x9, #0x20
 7d8:	54fffdc3 	b.cc	790 <PQCLEAN_HQC128_CLEAN_vect_add+0x10>  // b.lo, b.ul, b.last
 7dc:	927ef468 	and	x8, x3, #0xfffffffffffffffc
 7e0:	91004029 	add	x9, x1, #0x10
 7e4:	9100404a 	add	x10, x2, #0x10
 7e8:	9100400b 	add	x11, x0, #0x10
 7ec:	aa0803ec 	mov	x12, x8
 7f0:	ad7f8d40 	ldp	q0, q3, [x10, #-16]
 7f4:	f100118c 	subs	x12, x12, #0x4
 7f8:	ad7f8921 	ldp	q1, q2, [x9, #-16]
 7fc:	91008129 	add	x9, x9, #0x20
 800:	9100814a 	add	x10, x10, #0x20
 804:	6e211c00 	eor	v0.16b, v0.16b, v1.16b
 808:	6e221c61 	eor	v1.16b, v3.16b, v2.16b
 80c:	ad3f8560 	stp	q0, q1, [x11, #-16]
 810:	9100816b 	add	x11, x11, #0x20
 814:	54fffee1 	b.ne	7f0 <PQCLEAN_HQC128_CLEAN_vect_add+0x70>  // b.any
 818:	eb03011f 	cmp	x8, x3
 81c:	54fffba1 	b.ne	790 <PQCLEAN_HQC128_CLEAN_vect_add+0x10>  // b.any
 820:	17ffffe7 	b	7bc <PQCLEAN_HQC128_CLEAN_vect_add+0x3c>

0000000000000824 <PQCLEAN_HQC128_CLEAN_vect_compare>:
 824:	b40000c2 	cbz	x2, 83c <PQCLEAN_HQC128_CLEAN_vect_compare+0x18>
 828:	f100205f 	cmp	x2, #0x8
 82c:	540000c2 	b.cs	844 <PQCLEAN_HQC128_CLEAN_vect_compare+0x20>  // b.hs, b.nlast
 830:	aa1f03e8 	mov	x8, xzr
 834:	52802009 	mov	w9, #0x100                 	// #256
 838:	14000044 	b	948 <PQCLEAN_HQC128_CLEAN_vect_compare+0x124>
 83c:	2a1f03e0 	mov	w0, wzr
 840:	d65f03c0 	ret
 844:	f100805f 	cmp	x2, #0x20
 848:	54000082 	b.cs	858 <PQCLEAN_HQC128_CLEAN_vect_compare+0x34>  // b.hs, b.nlast
 84c:	aa1f03e8 	mov	x8, xzr
 850:	52802009 	mov	w9, #0x100                 	// #256
 854:	14000027 	b	8f0 <PQCLEAN_HQC128_CLEAN_vect_compare+0xcc>
 858:	6f00e400 	movi	v0.2d, #0x0
 85c:	6f00e401 	movi	v1.2d, #0x0
 860:	90000009 	adrp	x9, 0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight>
 864:	6f00e402 	movi	v2.2d, #0x0
 868:	927be848 	and	x8, x2, #0xffffffffffffffe0
 86c:	3dc00123 	ldr	q3, [x9]
 870:	91004009 	add	x9, x0, #0x10
 874:	9100402a 	add	x10, x1, #0x10
 878:	aa0803eb 	mov	x11, x8
 87c:	ad7f9d44 	ldp	q4, q7, [x10, #-16]
 880:	f100816b 	subs	x11, x11, #0x20
 884:	ad7f9925 	ldp	q5, q6, [x9, #-16]
 888:	91008129 	add	x9, x9, #0x20
 88c:	9100814a 	add	x10, x10, #0x20
 890:	6e251c84 	eor	v4.16b, v4.16b, v5.16b
 894:	6e261ce5 	eor	v5.16b, v7.16b, v6.16b
 898:	6f08a486 	uxtl2	v6.8h, v4.16b
 89c:	2f08a484 	uxtl	v4.8h, v4.8b
 8a0:	2f08a4a7 	uxtl	v7.8h, v5.8b
 8a4:	6f08a4a5 	uxtl2	v5.8h, v5.16b
 8a8:	4ea61c00 	orr	v0.16b, v0.16b, v6.16b
 8ac:	4ea41c63 	orr	v3.16b, v3.16b, v4.16b
 8b0:	4ea71c21 	orr	v1.16b, v1.16b, v7.16b
 8b4:	4ea51c42 	orr	v2.16b, v2.16b, v5.16b
 8b8:	54fffe21 	b.ne	87c <PQCLEAN_HQC128_CLEAN_vect_compare+0x58>  // b.any
 8bc:	4ea31c21 	orr	v1.16b, v1.16b, v3.16b
 8c0:	4ea01c40 	orr	v0.16b, v2.16b, v0.16b
 8c4:	eb02011f 	cmp	x8, x2
 8c8:	4ea01c20 	orr	v0.16b, v1.16b, v0.16b
 8cc:	6e004001 	ext	v1.16b, v0.16b, v0.16b, #8
 8d0:	0ea11c00 	orr	v0.8b, v0.8b, v1.8b
 8d4:	9e660009 	fmov	x9, d0
 8d8:	aa498129 	orr	x9, x9, x9, lsr #32
 8dc:	d350fd2a 	lsr	x10, x9, #16
 8e0:	2a0a0129 	orr	w9, w9, w10
 8e4:	54000440 	b.eq	96c <PQCLEAN_HQC128_CLEAN_vect_compare+0x148>  // b.none
 8e8:	f27d045f 	tst	x2, #0x18
 8ec:	540002e0 	b.eq	948 <PQCLEAN_HQC128_CLEAN_vect_compare+0x124>  // b.none
 8f0:	6f00e400 	movi	v0.2d, #0x0
 8f4:	aa0803eb 	mov	x11, x8
 8f8:	927df048 	and	x8, x2, #0xfffffffffffffff8
 8fc:	8b0b002a 	add	x10, x1, x11
 900:	4e021d20 	mov	v0.h[0], w9
 904:	8b0b0009 	add	x9, x0, x11
 908:	cb08016b 	sub	x11, x11, x8
 90c:	fc408521 	ldr	d1, [x9], #8
 910:	b100216b 	adds	x11, x11, #0x8
 914:	fc408542 	ldr	d2, [x10], #8
 918:	2e211c41 	eor	v1.8b, v2.8b, v1.8b
 91c:	2f08a421 	uxtl	v1.8h, v1.8b
 920:	4ea11c00 	orr	v0.16b, v0.16b, v1.16b
 924:	54ffff41 	b.ne	90c <PQCLEAN_HQC128_CLEAN_vect_compare+0xe8>  // b.any
 928:	6e004001 	ext	v1.16b, v0.16b, v0.16b, #8
 92c:	eb02011f 	cmp	x8, x2
 930:	0ea11c00 	orr	v0.8b, v0.8b, v1.8b
 934:	9e660009 	fmov	x9, d0
 938:	aa498129 	orr	x9, x9, x9, lsr #32
 93c:	d350fd2a 	lsr	x10, x9, #16
 940:	2a0a0129 	orr	w9, w9, w10
 944:	54000140 	b.eq	96c <PQCLEAN_HQC128_CLEAN_vect_compare+0x148>  // b.none
 948:	cb08004a 	sub	x10, x2, x8
 94c:	8b08002b 	add	x11, x1, x8
 950:	8b080008 	add	x8, x0, x8
 954:	3840150c 	ldrb	w12, [x8], #1
 958:	f100054a 	subs	x10, x10, #0x1
 95c:	3840156d 	ldrb	w13, [x11], #1
 960:	4a0c01ac 	eor	w12, w13, w12
 964:	2a0c0129 	orr	w9, w9, w12
 968:	54ffff61 	b.ne	954 <PQCLEAN_HQC128_CLEAN_vect_compare+0x130>  // b.any
 96c:	529fffe8 	mov	w8, #0xffff                	// #65535
 970:	0b292108 	add	w8, w8, w9, uxth
 974:	53087d00 	lsr	w0, w8, #8
 978:	d65f03c0 	ret

000000000000097c <PQCLEAN_HQC128_CLEAN_vect_resize>:
 97c:	aa0203e8 	mov	x8, x2
 980:	6b03003f 	cmp	w1, w3
 984:	54000242 	b.cs	9cc <PQCLEAN_HQC128_CLEAN_vect_resize+0x50>  // b.hs, b.nlast
 988:	a9be7bfd 	stp	x29, x30, [sp, #-32]!
 98c:	a9014ff4 	stp	x20, x19, [sp, #16]
 990:	910003fd 	mov	x29, sp
 994:	12001433 	and	w19, w1, #0x3f
 998:	aa0803e1 	mov	x1, x8
 99c:	52811402 	mov	w2, #0x8a0                 	// #2208
 9a0:	aa0003f4 	mov	x20, x0
 9a4:	94000000 	bl	0 <memcpy>
 9a8:	34000613 	cbz	w19, a68 <PQCLEAN_HQC128_CLEAN_vect_resize+0xec>
 9ac:	52800809 	mov	w9, #0x40                  	// #64
 9b0:	f9444e8b 	ldr	x11, [x20, #2200]
 9b4:	aa1403e8 	mov	x8, x20
 9b8:	7100f27f 	cmp	w19, #0x3c
 9bc:	4b130129 	sub	w9, w9, w19
 9c0:	54000109 	b.ls	9e0 <PQCLEAN_HQC128_CLEAN_vect_resize+0x64>  // b.plast
 9c4:	aa1f03ea 	mov	x10, xzr
 9c8:	14000021 	b	a4c <PQCLEAN_HQC128_CLEAN_vect_resize+0xd0>
 9cc:	1100fc69 	add	w9, w3, #0x3f
 9d0:	aa0803e1 	mov	x1, x8
 9d4:	53037d29 	lsr	w9, w9, #3
 9d8:	121d6522 	and	w2, w9, #0x1ffffff8
 9dc:	14000000 	b	0 <memcpy>
 9e0:	6f07e7e0 	movi	v0.2d, #0xffffffffffffffff
 9e4:	6f07e7e1 	movi	v1.2d, #0xffffffffffffffff
 9e8:	9280002a 	mov	x10, #0xfffffffffffffffe    	// #-2
 9ec:	9000000c 	adrp	x12, 0 <PQCLEAN_HQC128_CLEAN_vect_set_random_fixed_weight>
 9f0:	4e080d43 	dup	v3.2d, x10
 9f4:	927e112a 	and	x10, x9, #0x7c
 9f8:	3dc00185 	ldr	q5, [x12]
 9fc:	4e081d60 	mov	v0.d[0], x11
 a00:	6ee0f822 	fneg	v2.2d, v1.2d
 a04:	5280008b 	mov	w11, #0x4                   	// #4
 a08:	4e080d64 	dup	v4.2d, x11
 a0c:	aa0a03eb 	mov	x11, x10
 a10:	6ee0b8a6 	neg	v6.2d, v5.2d
 a14:	6ee58467 	sub	v7.2d, v3.2d, v5.2d
 a18:	f100116b 	subs	x11, x11, #0x4
 a1c:	4ee484a5 	add	v5.2d, v5.2d, v4.2d
 a20:	6ee64446 	ushl	v6.2d, v2.2d, v6.2d
 a24:	6ee74447 	ushl	v7.2d, v2.2d, v7.2d
 a28:	4e261c00 	and	v0.16b, v0.16b, v6.16b
 a2c:	4e271c21 	and	v1.16b, v1.16b, v7.16b
 a30:	54ffff01 	b.ne	a10 <PQCLEAN_HQC128_CLEAN_vect_resize+0x94>  // b.any
 a34:	4e201c20 	and	v0.16b, v1.16b, v0.16b
 a38:	eb09015f 	cmp	x10, x9
 a3c:	6e004001 	ext	v1.16b, v0.16b, v0.16b, #8
 a40:	0e211c00 	and	v0.8b, v0.8b, v1.8b
 a44:	9e66000b 	fmov	x11, d0
 a48:	540000e0 	b.eq	a64 <PQCLEAN_HQC128_CLEAN_vect_resize+0xe8>  // b.none
 a4c:	92f0000c 	mov	x12, #0x7fffffffffffffff    	// #9223372036854775807
 a50:	9aca258d 	lsr	x13, x12, x10
 a54:	9100054a 	add	x10, x10, #0x1
 a58:	eb0a013f 	cmp	x9, x10
 a5c:	8a0d016b 	and	x11, x11, x13
 a60:	54ffff81 	b.ne	a50 <PQCLEAN_HQC128_CLEAN_vect_resize+0xd4>  // b.any
 a64:	f9044d0b 	str	x11, [x8, #2200]
 a68:	a9414ff4 	ldp	x20, x19, [sp, #16]
 a6c:	a8c27bfd 	ldp	x29, x30, [sp], #32
 a70:	d65f03c0 	ret
